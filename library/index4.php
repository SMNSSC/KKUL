  ...
  <div class="row">
      ...
      <div class="col-sm-6 col-md-6 col-lg-6">
        ...
        <map name="image-map">
          ...
          <area target="" alt="Planning" title="Planning" coords="252,117,115" shape="circle" href="#Planning">
<!--alert-->  <div id="Planning" class="alert alert-success" alert-dismissible fade in" >
...
<!-- alert-->   </div>   
          ...
          <area target="" alt="Working" title="Working" coords="381,334,116" shape="circle">
          </area>

          <area target="" alt="Publishing" title="Publishing" coords="128,340,112" shape="circle">
          </area>   
